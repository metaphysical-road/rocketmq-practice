...
public class DynamicQueueProducerServer {
    public static void main(String[] args){
        SpringApplication springApplication=new SpringApplication(DynamicQueueProducerServer.class);
    ...
    static class ProducerThreadB implements Runnable {
        ...
        @Override
        public void run() {
            mqProducer = new DefaultMQProducer("dynamicQueueTest");
            ...
            while (true) {
                ...
                try {
                    Message msg = new Message("dynamicQueueTest",
                            "order454545",
                            "454545",
