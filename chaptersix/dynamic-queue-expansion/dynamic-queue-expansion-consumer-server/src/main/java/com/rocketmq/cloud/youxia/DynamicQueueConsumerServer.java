...
public class DynamicQueueConsumerServer{
    public static void main(String[] args) throws MQClientException{
        SpringApplication springApplication=new SpringApplication(DynamicQueueConsumerServer.class);
    ...
    public static void startConsumerInstanceA() throws MQClientException {
        DefaultMQPushConsumer defaultMQPushConsumerOne=new DefaultMQPushConsumer("dynamicQueueTestA");
        defaultMQPushConsumerOne.setNamesrvAddr("127.0.0.1:9876");
        defaultMQPushConsumerOne.setInstanceName("clientIdOne");
        defaultMQPushConsumerOne.subscribe("dynamicQueueTest","");
    ...
    public static void startConsumerInstanceB() throws MQClientException{
        DefaultMQPushConsumer defaultMQPushConsumerTwo=new DefaultMQPushConsumer("dynamicQueueTestA");
        defaultMQPushConsumerTwo.setNamesrvAddr("127.0.0.1:9876");
        defaultMQPushConsumerTwo.setInstanceName("clientIdTwo");
        defaultMQPushConsumerTwo.subscribe("dynamicQueueTest","");
    ...
    public static void startConsumerInstanceC() throws MQClientException{
        DefaultMQPushConsumer defaultMQPushConsumerThree=new DefaultMQPushConsumer("dynamicQueueTestA");
        defaultMQPushConsumerThree.setNamesrvAddr("127.0.0.1:9876");
        defaultMQPushConsumerThree.setInstanceName("clientIdThree");
        defaultMQPushConsumerThree.subscribe("dynamicQueueTest","");
