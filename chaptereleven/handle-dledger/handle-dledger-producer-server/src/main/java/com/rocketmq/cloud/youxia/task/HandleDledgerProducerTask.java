...
import com.rocketmq.cloud.youxia.config.HandleDledgerProducerConfig;
...
@Component
@EnableScheduling
public class HandleDledgerProducerTask {
    ...
    @Autowired
    private HandleDledgerProducerConfig handleDledgerProducerConfig;
