...
import com.rocketmq.cloud.youxia.config.HandleDledgerConsumerConfig;
...
@Component
@EnableScheduling
public class HandleDledgerConsumerTask {
    ...
    @Autowired
    private HandleDledgerConsumerConfig handleDledgerConsumerConfig;
