...
import com.rocketmq.cloud.youxia.config.MasterUpdateProducerConfig;
...
@Component
@EnableScheduling
public class MasterUpdateProducerTask {
    ...
    @Autowired
    private MasterUpdateProducerConfig handleDledgerProducerConfig;
