...
public class MasterUpdateDledgerConfig {
    ...
    private String changeCluster;
    private String moveMessageSuccess;
    private String newNamesrvAddr;
    ...
    public String getChangeCluster() {
        return changeCluster;
    }

    public void setChangeCluster(String changeCluster) {
        this.changeCluster = changeCluster;
    }

    public String getMoveMessageSuccess() {
        return moveMessageSuccess;
    }

    public void setMoveMessageSuccess(String moveMessageSuccess) {
        this.moveMessageSuccess = moveMessageSuccess;
    }

    public String getNewNamesrvAddr() {
        return newNamesrvAddr;
    }

    public void setNewNamesrvAddr(String newNamesrvAddr) {
        this.newNamesrvAddr = newNamesrvAddr;
    }
}
