...
public class DeadQueueConsumerConfig {
    private String instanceName;
    private String deadInstanceName;
    private String clientIp;
    private String namesrvAddr;
    private String topic;
    private Integer consumerNum;
    private String consumerGroup;
    private String deadConsumerGroup;
    ...
    public String getDeadInstanceName() {
        return deadInstanceName;
    }

    public void setDeadInstanceName(String deadInstanceName) {
        this.deadInstanceName = deadInstanceName;
    }
    ...
    public String getDeadConsumerGroup() {
        return deadConsumerGroup;
    }

    public void setDeadConsumerGroup(String deadConsumerGroup) {
        this.deadConsumerGroup = deadConsumerGroup;
    }
