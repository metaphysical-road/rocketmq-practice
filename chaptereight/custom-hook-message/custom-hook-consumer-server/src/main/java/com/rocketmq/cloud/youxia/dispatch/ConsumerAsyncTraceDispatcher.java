package com.rocketmq.cloud.youxia.dispatch;
...
public class ConsumerAsyncTraceDispatcher implements TraceDispatcher{
    ...
    public ConsumerAsyncTraceDispatcher(String group, Type type, String traceTopicName, RPCHook rpcHook) {
    ...
    public void start(String nameSrvAddr, AccessChannel accessChannel) throws MQClientException {
        ...
        this.accessChannel = accessChannel;
        this.worker = new Thread(new ConsumerAsyncTraceDispatcher.AsyncRunnable(), "MQ-AsyncTraceDispatcher-Thread-" + dispatcherId);
        ...
        public void run() {
            while (!stopped) {
                ...
                synchronized (traceContextQueue) {
                    ...
                    if (contexts.size() > 0) {
                        ConsumerAsyncTraceDispatcher.AsyncAppenderRequest request = new ConsumerAsyncTraceDispatcher.AsyncAppenderRequest(contexts);
                        traceExecutor.submit(request);
                    } else if (ConsumerAsyncTraceDispatcher.this.stopped) {
                        this.stopped = true;
                    }
                }
            }
