...
public class ProducerAsyncTraceDispatcher implements TraceDispatcher{
    ...
    public ProducerAsyncTraceDispatcher(String group, Type type, String traceTopicName, RPCHook rpcHook) {
        ...
        public void run() {
            while (!stopped) {
                ...
                synchronized (traceContextQueue) {
                    ...
                    } else if (ProducerAsyncTraceDispatcher.this.stopped) {
                        this.stopped = true;
                    }
                }
            }
