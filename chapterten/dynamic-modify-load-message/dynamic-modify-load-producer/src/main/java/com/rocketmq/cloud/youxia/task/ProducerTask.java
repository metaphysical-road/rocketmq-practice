...
public class ProducerTask {
    ...
    @Resource
    private DynamicModifyLoadConfig singleProducerConfig;
    ...
    public void producerMessage() {
        if (null == defaultMQProducer) {
            ...
            defaultMQProducer.setDefaultTopicQueueNums(singleProducerConfig.getTopicQueueNums());
            defaultMQProducer.setUnitName(singleProducerConfig.getUnitName());
            try {
