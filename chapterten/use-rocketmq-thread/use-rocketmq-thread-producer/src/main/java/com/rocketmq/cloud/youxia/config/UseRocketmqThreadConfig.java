...
public class UseRocketmqThreadConfig {
    ...
    private String isUseThread;
    private String isUseThreadAndQueue;
    ...
    public String getIsUseThread() {
        return isUseThread;
    }

    public void setIsUseThread(String isUseThread) {
        this.isUseThread = isUseThread;
    }

    public String getIsUseThreadAndQueue() {
        return isUseThreadAndQueue;
    }

    public void setIsUseThreadAndQueue(String isUseThreadAndQueue) {
        this.isUseThreadAndQueue = isUseThreadAndQueue;
    }
}
